...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    repo: 'zcy946/blog', // 导航栏右侧生成Github链接
    ...
    author: {
      name: '夏黎辰', // 必需
      link: 'https://github.com/zcy946', // 可选的
    },
    ...
    footer: {
      ...
      copyrightInfo:
        ...
        '<a href="/" target="_blank">夏黎辰的博客</a> | <a href="/friends" target="_blank">友情链接</a>', // 博客版权信息、备案信息等，支持a标签或换行标签</br>
    },
